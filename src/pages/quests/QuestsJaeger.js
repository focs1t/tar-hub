...
export default function QuestsJaeger() {
  const quests = questsData.quests.filter(quest => quest.trader === "jaeger");
        ...
        <div className="articles">
          {quests.map((quest) => (
            <article key={quest.id} className="article">
              <Link to={`/quests/jaeger/${quest.id}`}>
                <img src={quest.image} alt={quest.content} className="article-image" />
              </Link>
              <Link to={`/quests/jaeger/${quest.id}`} className="article-title">
                {quest.title}
              </Link>
              <div className="article-text">
                {quest.content}
              </div>
              <Link to={`/quests/jaeger/${quest.id}`} className="article-more">
                Читать далее
              </Link>
            </article>
          ))}
